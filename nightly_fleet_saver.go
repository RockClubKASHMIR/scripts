...
This script saves all your fleets, even from planets (if you have a moon on that planet, the fleet will be sent to the moon first, and then the fleet saver will save it).
It goes to sleep mode only if all your fleets are saved.
The fleet saver recalls your fleets at half the flight time of your fastest fleet, then goes into sleep mode for the remaining time.
