...
discord channel for your personal orders and support - https://discord.gg/zgTuT3
 ...
 3. Can check and recycle debris from more than 1 planet/moon 
 4. Possible to make a scan and recycle debris in different solar systems
 5. You can set the minimum amount of Recyclers for recycle
 6. Sends Recyclers to same debris only if already sended ships are not enough to get all resources
...
HowManyRepeats = 5 // Set the limit of repeats of full scanning for debris - 0 means forewer
