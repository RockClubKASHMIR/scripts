...
home_planet = "P:1:130:11"

send_to_home = false // At the end of the whole farming and with this set true
                    // all your farm planets will send all ressources to home_planet


//### FARMER ###                   
farm_planets = ["P:1:232:4"]//, "P:3:411:9", "P:3:88:8", "P:2:247:7", "P:2:88:9", "P:1:248:9"
