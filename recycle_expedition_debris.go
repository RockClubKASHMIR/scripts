/***** This script is created by RockClubKASHMIR <discord @RockClubKASHMIR#8058> *****\
 <discord channel for your orders and support - https://discord.gg/zgTuT3
 v1.1
...
HowManyRepeats = 5 // Set the limit of repeats of full scanning for EXPO debris - 0 means forewer, 1 - will repeat once
        ...
        if home >= len(homes)-1 {
            ...
            if RepeatTimes != HowManyRepeats {
                ...
                if marker >= len(homes)-1 {
                    if nbr == 0 {
                        Print("Not found any debris! Start searching again after "+ShortDur(delay))
                        Sleep(3000)
                    }
                    if Repeat == true {
